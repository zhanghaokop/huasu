...
// function afterSale(obj){
// 	if($('.repair-menu').hasClass('in')){
// 		$('.repair-menu').removeClass('in').addClass('out');
// 		$(obj).addClass('collapsed');
// 	}else{
// 		$('.repair-menu').removeClass('out').addClass('in');
// 		$(obj).removeClass('collapsed');
// 	}
// }
// function report(obj){
// 	if($('.report-menu').hasClass('in')){
// 		$('.report-menu').removeClass('in').addClass('out');
// 		$(obj).addClass('collapsed');
// 	}else{
// 		$('.report-menu').removeClass('out').addClass('in');
// 		$(obj).removeClass('collapsed');
// 	}
// }
...
function logout(){
	...
	if(r==true){
		$.ajax({
            url:ROUTE('/ajax_customer/logout'),
            type:"post",
            dataType:"json",
